...
[![](./plots/rasuwa_population_map.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_population_map.png){width="100%"}
...
[![](./plots/rasuwa_poorest_quintile_map.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_poorest_quintile_map.png){width="100%"}
...
[![](./plots/rasuwa_impacted_buildings.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_impacted_buildings.png){width="100%"}
...
municipal_damage_losses |> 
  ...
  kable(caption = "Economic impacts and losses in Rasuwa") |> 
...
[![](./plots/rasuwa_reached_map.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_reached_map.png){width="100%"}



<br>

The majority of the individuals reached have been in Gosaikunda. However, as we can see from the beneficiary frequencies map below (which is inclusive of double counting, and thus indicative of where agencies have focused their resources), affected persons in Gosaikunda have been reached primarily by WASH activities. 

<br>

[![](./plots/rasuwa_frequencies_facet_map.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_frequencies_facet_map.png){width="100%"}



<br>

We still lack more granular data. As can be seen from the table below, almost none of the activities in Gosaikunda have been reported at ward level. Uttargaya is the municipality with the best ward-level reporting. 2,958 beneficiary frequencies (inclusive of double counting) have no municipality reported at all. Withouth ward-level data, it will not be possible to tell on which side of the river activities have occurred. 
...
consolidated |> 
  ...
  summarise(
    ...
    .groups = "drop") |> 
  mutate(individuals_reached = round(individuals_reached)) |> 
  pivot_wider(
    names_from = has_ward, 
  ...
  kable(caption = "Ward-level reporting of beneficiary frequencies") |> 
  kable_classic(full_width = F) |> 
  kable_styling(bootstrap_options = "striped")
...
[![](./plots/rasuwa_sector_agencies_facet_map.png)](https://raw.githubusercontent.com/nepal-rasuwa-trishuli-floods-undac/nepal_floods_reports/main/plots/rasuwa_sector_agencies_facet_map.png){width="100%"}
...
consolidated |> 
  ...
  summarise(num_agencies = n_distinct(agencies),
            ...
            .groups = "drop") |> 
  mutate(agencies = str_wrap(agencies, width = 50)) |> 
  select(-adm2_pcode, -adm3_pcode) |> 
  kable(caption = "Agencies by municipality") |> 
  kable_classic(full_width = F) |> 
  kable_styling(bootstrap_options = "striped")
...
### [Geodata](https://drive.google.com/drive/folders/1_QuN6UTia2irDmADubMoklrvTptL9gbu?usp=drive_link)
Includes ward-level shapefiles and settlement points.
...
### [Online version of this report](https://nepal-rasuwa-trishuli-floods-undac.github.io/nepal_floods_reports/rasuwa_district_profile.html)