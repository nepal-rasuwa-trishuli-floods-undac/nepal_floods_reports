...
logo:
  images:
    light: brand/combined_logos.png
execute: 
  echo: false
---
...
municipal_damage_losses |> 
  ...
  kbl(caption = "Economic impacts and losses in Rasuwa") |> 
...
consolidated |> 
  ...
  kbl(caption = "Ward-level reporting of beneficiary frequencies") |> 
  kable_classic(full_width = F) |> 
  kable_styling(bootstrap_options = "striped")
...
consolidated |> 
  ...
  kbl(caption = "Agencies by municipality") |> 
